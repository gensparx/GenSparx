...
let originalGensparxTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalGensparxTestConsole = process.env.GENSPARX_TEST_CONSOLE;
  process.env.GENSPARX_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalGensparxTestConsole === undefined) {
    delete process.env.GENSPARX_TEST_CONSOLE;
  } else {
    process.env.GENSPARX_TEST_CONSOLE = originalGensparxTestConsole;
  }
