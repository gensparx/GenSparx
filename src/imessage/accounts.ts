...
function mergeIMessageAccountConfig(cfg: GensparxConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: GensparxConfig): ResolvedIMessageAccount[] {
