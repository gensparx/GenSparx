...
export function listWhatsAppAuthDirs(cfg: GensparxConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: GensparxConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: GensparxConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: GensparxConfig): ResolvedWhatsAppAccount[] {
