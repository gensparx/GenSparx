...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/gensparx/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/gensparx/extensions",
        global: "/Users/x/.gensparx/extensions",
        workspace: "/Users/x/ws/.gensparx/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.gensparx/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/gensparx/extensions",
        global: "/Users/x/.gensparx/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.gensparx/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/gensparx/extensions",
        global: "/Users/x/.gensparx/extensions",
