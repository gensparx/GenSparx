...
export function hasAmbiguousGatewayAuthModeConfig(cfg: GensparxConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: GensparxConfig): void {
