...
import { type GensparxConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: GensparxConfig): string[] {
...
export function listAgentsForGateway(cfg: GensparxConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: GensparxConfig): string {
...
function resolveSessionStoreAgentId(cfg: GensparxConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: GensparxConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: GensparxConfig): GatewaySessionsDefaults {
