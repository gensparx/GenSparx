...
function resolveDefaultAccountId(cfg: GensparxConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: GensparxConfig): boolean {
...
export function summarizeBindings(cfg: GensparxConfig, bindings: AgentBinding[]): string[] {
