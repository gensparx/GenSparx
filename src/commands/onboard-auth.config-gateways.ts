...
export function applyVercelAiGatewayProviderConfig(cfg: GensparxConfig): GensparxConfig {
...
export function applyVercelAiGatewayConfig(cfg: GensparxConfig): GensparxConfig {
