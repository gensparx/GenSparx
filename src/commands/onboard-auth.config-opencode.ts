...
export function applyOpencodeZenProviderConfig(cfg: GensparxConfig): GensparxConfig {
...
export function applyOpencodeZenConfig(cfg: GensparxConfig): GensparxConfig {
