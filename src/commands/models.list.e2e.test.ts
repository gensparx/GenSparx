...
const ensureGensparxModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveGensparxAgentDir = vi.fn().mockReturnValue("/tmp/gensparx-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/gensparx-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureGensparxModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveGensparxAgentDir,
}));
