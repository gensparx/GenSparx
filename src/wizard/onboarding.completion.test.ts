...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("gensparx");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "gensparx");
