...
function resolveResolutionLimits(config: GensparxConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: GensparxConfig): SecretProviderConfig {
