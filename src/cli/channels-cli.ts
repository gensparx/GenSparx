    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["gensparx channels list", "List configured channels and auth profiles."],
          ["gensparx channels status --probe", "Run channel status checks and probes."],
          [
            "gensparx channels add --channel telegram --token <token>",
