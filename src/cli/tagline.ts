const DEFAULT_TAGLINE = "All your chats, one GenSparx.";
...
const TAGLINES: string[] = [
  ...
  "Sparks out, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a spark: fast, focused, effective.",
  ...
  "The only signal in your contacts you actually want to hear from. 🦞",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env.GENSPARX_TAGLINE_INDEX ?? env.OPENCLAW_TAGLINE_INDEX;
