...
const STEP_LABELS: Record<string, string> = {
  ...
  "gensparx doctor entry": "Checking doctor entrypoint",
...
export function inferUpdateFailureHints(result: UpdateRunResult): string[] {
  ...
  if (failedStep.name.startsWith("global update") && stderr.includes("eacces")) {
    ...
    hints.push("Example: npm config set prefix ~/.local && npm i -g gensparx@latest");
  }
  ...
  if (
    ...
    hints.push("If it still fails: npm i -g gensparx@latest --omit=optional");
  }
