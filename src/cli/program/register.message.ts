...
${formatHelpExamples([
  ['gensparx message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'gensparx message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'gensparx message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.gensparx.com/cli/message")}`,
    )
    .action(() => {
