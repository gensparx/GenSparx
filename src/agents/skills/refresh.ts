...
function resolveWatchPaths(workspaceDir: string, config?: GensparxConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: GensparxConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: GensparxConfig }) {
