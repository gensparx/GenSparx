...
describe("buildAgentSystemPrompt", () => {
  ...
  it("marks system message blocks as internal and not user-visible", () => {
    ...
    expect(prompt).toContain("automatically routes to the source channel");
  });
  ...
  it("omits ACP harness guidance when ACP is disabled", () => {
    ...
    expect(prompt).toContain("- agents_list: List agent ids allowed for sessions_spawn");
  });
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("GenSparx docs: /tmp/openclaw/docs");
    expect(prompt).toContain(
