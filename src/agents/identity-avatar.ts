...
function resolveAvatarSource(cfg: GensparxConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: GensparxConfig, agentId: string): AgentAvatarResolution {
