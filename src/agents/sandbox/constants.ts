...
export const DEFAULT_SANDBOX_IMAGE = "gensparx-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "gensparx-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "gensparx-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "gensparx-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "gensparx-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "gensparx-sandbox-browser";
