...
const CLEANUP_STATE_KEY = Symbol.for("gensparx.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("gensparx.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("gensparx.sessionWriteLockWatchdogState");
