...
describe("createGensparxCodingTools", () => {
  ...
  it("filters tools by sandbox policy", () => {
    const sandboxDir = path.join(os.tmpdir(), "gensparx-sandbox");
    const sandbox = createPiToolsSandboxContext({
      workspaceDir: sandboxDir,
      agentWorkspaceDir: path.join(os.tmpdir(), "gensparx-workspace"),
    ...
    const tools = createGensparxCodingTools({ sandbox });
