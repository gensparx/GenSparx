...
function resolveAdaptiveReadMaxBytes(options?: GensparxReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createGensparxReadTool(base, {
...
export function createGensparxReadTool(
  base: AnyAgentTool,
  options?: GensparxReadToolOptions,
): AnyAgentTool {
