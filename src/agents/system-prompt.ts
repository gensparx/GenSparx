...
export function buildAgentSystemPrompt(params: {
  ...
  const coreToolSummaries: Record<string, string> = {
    ...
    agents_list: acpSpawnRuntimeEnabled
      ? 'List gensparx agent ids allowed for sessions_spawn when runtime="subagent" (not ACP harness ids)'
      : "List gensparx agent ids allowed for sessions_spawn",
  ...
  if (promptMode === "none") {
    return "You are a personal assistant running inside Gensparx.";
  }

  const lines = [
    "You are a personal assistant running inside Gensparx.",
    "",
    "## Tooling",
