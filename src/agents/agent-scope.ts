...
type AgentEntry = NonNullable<NonNullable<GensparxConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: GensparxConfig): AgentEntry[] {
...
export function listAgentIds(cfg: GensparxConfig): string[] {
...
export function resolveDefaultAgentId(cfg: GensparxConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: GensparxConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: GensparxConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: GensparxConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: GensparxConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
