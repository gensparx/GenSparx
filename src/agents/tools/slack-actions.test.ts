...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): GensparxConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: GensparxConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: GensparxConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
