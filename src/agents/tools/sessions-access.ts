...
export function resolveSessionToolsVisibility(cfg: GensparxConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: GensparxConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: GensparxConfig): AgentToAgentPolicy {
