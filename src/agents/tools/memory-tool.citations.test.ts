...
function asGensparxConfig(config: Partial<GensparxConfig>): GensparxConfig {
  return config as GensparxConfig;
}

function createToolConfig() {
  return asGensparxConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: GensparxConfig = createToolConfig()) {
