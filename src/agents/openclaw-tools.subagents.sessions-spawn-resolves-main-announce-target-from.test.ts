...
describe("gensparx-tools: subagents", () => {
  ...
  it("sessions_spawn runs cleanup flow after subagent completion", async () => {
    ...
    // Subagent spawn is required; main agent trigger can be hook/routing dependent.
    ...
    // Optional second call: main agent trigger (not "Sub-agent announce step." anymore)
