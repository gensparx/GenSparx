...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/gensparx/gensparx/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.GENSPARX_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.gensparx/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: GensparxConfig = {
    ...params.cfg,
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: async (providerOverride, modelOverride, runOptions) => {
          ...
          if (isCliProvider(providerOverride, cfgWithAgentDefaults)) {
            ...
            // the configured timeoutSeconds. See: https://github.com/gensparx/gensparx/issues/29774
