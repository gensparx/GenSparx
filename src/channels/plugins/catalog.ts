...
import { discoverGensparxPlugins } from "../../plugins/discovery.js";
import type { GensparxPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["GENSPARX_PLUGIN_CATALOG_PATHS", "GENSPARX_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<GensparxPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: GensparxPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: GensparxPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverGensparxPlugins({ workspaceDir: options.workspaceDir });
