...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: GensparxConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: GensparxConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: GensparxConfig) => string;
  setAccountEnabled?: (params: {
    cfg: GensparxConfig;
    accountId: string;
    enabled: boolean;
  }) => GensparxConfig;
  deleteAccount?: (params: { cfg: GensparxConfig; accountId: string }) => GensparxConfig;
  isEnabled?: (account: ResolvedAccount, cfg: GensparxConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: GensparxConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: GensparxConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: GensparxConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: GensparxConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.gensparx.com/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: GensparxConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
