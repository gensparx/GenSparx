...
export function listChannelMessageActions(cfg: GensparxConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: GensparxConfig): boolean {
...
export function supportsChannelMessageCards(cfg: GensparxConfig): boolean {
