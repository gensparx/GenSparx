...
function resolveAnthropicDefaultAuthMode(cfg: GensparxConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: GensparxConfig): GensparxConfig {
...
export function applyTalkApiKey(config: GensparxConfig): GensparxConfig {
...
export function applyTalkConfigNormalization(config: GensparxConfig): GensparxConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: GensparxConfig): GensparxConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: GensparxConfig): GensparxConfig {
...
export function applyLoggingDefaults(cfg: GensparxConfig): GensparxConfig {
...
export function applyContextPruningDefaults(cfg: GensparxConfig): GensparxConfig {
...
export function applyCompactionDefaults(cfg: GensparxConfig): GensparxConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
