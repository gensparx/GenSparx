...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: GensparxConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: GensparxConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: GensparxConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: GensparxConfig }): Promise<void> {
