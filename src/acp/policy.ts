...
export function isAcpEnabledByPolicy(cfg: GensparxConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: GensparxConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: GensparxConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: GensparxConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: GensparxConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: GensparxConfig, agentId: string): boolean {
