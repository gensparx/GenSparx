/**
 * Hook system for gensparx agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __gensparx_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__gensparx_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
