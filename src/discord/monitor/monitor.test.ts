...
describe("agent components", () => {
  const createCfg = (): GensparxConfig => ({}) as GensparxConfig;
...
describe("discord component interactions", () => {
  const createCfg = (): GensparxConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/gensparx-sessions-test.json");
  });
