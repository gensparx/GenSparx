...
function mergeDiscordAccountConfig(cfg: GensparxConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: GensparxConfig): ResolvedDiscordAccount[] {
