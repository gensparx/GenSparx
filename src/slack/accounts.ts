...
function mergeSlackAccountConfig(cfg: GensparxConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: GensparxConfig): ResolvedSlackAccount[] {
