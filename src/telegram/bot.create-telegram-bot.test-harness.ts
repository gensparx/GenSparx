...
const { sessionStorePath } = vi.hoisted(() => ({
  sessionStorePath: `/tmp/gensparx-telegram-${process.pid}-${process.env.VITEST_POOL_ID ?? "0"}.json`,
}));
...
const DEFAULT_TELEGRAM_TEST_CONFIG: GensparxConfig = {
  agents: {
    defaults: {
