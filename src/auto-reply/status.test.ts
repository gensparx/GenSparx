...
describe("buildStatusMessage", () => {
  it("summarizes agent readiness and context usage", () => {
    ...
    expect(normalized).toContain("GenSparx");
  ...
  it("falls back to sessionEntry levels when resolved levels are not passed", () => {
    ...
    expect(normalized).toContain("Think: off");
    expect(normalized).not.toContain("verbose:full");
    expect(normalized).not.toContain("Reasoning: on");
  });
