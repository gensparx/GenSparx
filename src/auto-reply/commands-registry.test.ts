...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@gensparx", { botUsername: "gensparx" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@gensparx args", {
        botUsername: "gensparx",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@gensparx: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "gensparx" })).toBe(
      "/help@otherbot",
    );
  });
