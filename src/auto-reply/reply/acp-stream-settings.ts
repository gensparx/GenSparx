...
function resolveAcpStreamCoalesceIdleMs(cfg: GensparxConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: GensparxConfig): number {
...
export function resolveAcpProjectionSettings(cfg: GensparxConfig): AcpProjectionSettings {
