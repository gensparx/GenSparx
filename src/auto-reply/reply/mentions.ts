...
function resolveMentionPatterns(cfg: GensparxConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: GensparxConfig | undefined, agentId?: string): RegExp[] {
