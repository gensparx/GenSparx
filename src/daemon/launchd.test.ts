...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.gensparx.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", GENSPARX_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.gensparx.com/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when GENSPARX_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.gensparx.gateway.plist",
    },
    {
      name: "uses profile-specific label when GENSPARX_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", GENSPARX_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.gensparx.jbphoenix.plist",
    },
    {
      name: "prefers GENSPARX_LAUNCHD_LABEL over GENSPARX_PROFILE",
      env: {
        HOME: "/Users/test",
    ...
    {
      name: "trims whitespace from GENSPARX_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        GENSPARX_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty GENSPARX_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        GENSPARX_PROFILE: "myprofile",
        GENSPARX_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.gensparx.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
