...
export function listBindings(cfg: GensparxConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: GensparxConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: GensparxConfig) {
