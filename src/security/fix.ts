...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof GensparxConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: GensparxConfig; env: NodeJS.ProcessEnv }): {
  cfg: GensparxConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
