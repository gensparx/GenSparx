...
- Install via CLI: `gensparx plugins install @gensparx/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `gensparx plugins install ./extensions/zalo`
   - From npm (if published): `gensparx plugins install @gensparx/zalo`
...
- Approve via:
  - `gensparx pairing list zalo`
  - `gensparx pairing approve zalo <CODE>`
...
- Example: `gensparx message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `gensparx channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `gensparx logs --follow`
