...
- [Quick start and first-run setup]
  ...
  - [I can't access docs.gensparx.com (SSL error). What now?](#i-cant-access-docsgensparxai-ssl-error-what-now)
...
### I can't access docs.gensparx.com SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.gensparx.com` via Xfinity
Advanced Security. Disable it or allowlist `docs.gensparx.com`, then retry. More
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://gensparx.com/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://gensparx.com/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://gensparx.com/install.ps1](https://gensparx.com/install.ps1)
...
```bash
curl -fsSL https://gensparx.com/install.sh | bash -s -- --install-method git --verbose
```
...
Showcase: [https://gensparx.com/showcase](https://gensparx.com/showcase)
