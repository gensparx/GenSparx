---
summary: "Frequently asked questions about gensparx setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Gensparx?](#whats-the-recommended-way-to-install-and-set-up-gensparx)
  ...
  - [I can't access docs.gensparx.ai (SSL error). What now?](#i-cant-access-docsgensparxai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or gensparx not recognized](#windows-install-says-git-not-found-or-gensparx-not-recognized)
  ...
  - [How do I install gensparx on Linux?](#how-do-i-install-gensparx-on-linux)
  - [How do I install gensparx on a VPS?](#how-do-i-install-gensparx-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask gensparx to update itself?](#can-i-ask-gensparx-to-update-itself)
  ...
  - [If I buy a Mac mini to run Gensparx, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-gensparx-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different gensparx instances?](#can-multiple-people-use-one-whatsapp-number-with-different-gensparx-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run gensparx on a dedicated machine?](#how-important-is-it-to-run-gensparx-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run gensparx in a VM and what are the requirements](#can-i-run-gensparx-in-a-vm-and-what-are-the-requirements)
- [What is Gensparx?](#what-is-gensparx)
  - [What is Gensparx, in one paragraph?](#what-is-gensparx-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Gensparx](#what-are-the-top-five-everyday-use-cases-for-gensparx)
  - [Can gensparx help with lead gen outreach ads and blogs for a SaaS](#can-gensparx-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can gensparx run tasks on a schedule or continuously in the background?](#can-gensparx-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with gensparx saved locally?](#is-all-data-used-with-gensparx-saved-locally)
  - [Where does gensparx store its data?](#where-does-gensparx-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Gensparx?](#how-do-i-completely-uninstall-gensparx)
...
- [Config basics](#config-basics)
  ...
  - [Can the gensparx browser run headless?](#can-the-gensparx-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two gensparx instances talk to each other (local + VPS)?](#can-two-gensparx-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does gensparx load environment variables?](#how-does-gensparx-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of gensparx instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-gensparx-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset gensparx but keep it installed?](#how-do-i-completely-reset-gensparx-but-keep-it-installed)
  ...
  - [Why doesn't gensparx reply in a group?](#why-doesnt-gensparx-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Gensparx, Flawd, and Krill use for models?](#what-do-gensparx-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `gensparx gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-gensparx-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `gensparx gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-gensparx-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run gensparx in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-gensparx-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Gensparx?](#i-closed-my-terminal-on-windows-how-do-i-restart-gensparx)
  ...
  - [ELI5: `gensparx gateway restart` vs `gensparx gateway`](#eli5-gensparx-gateway-restart-vs-gensparx-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose gensparx to inbound DMs?](#is-it-safe-to-expose-gensparx-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/gensparx/gensparx-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   gensparx health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://gensparx.ai/install.sh | bash -s -- --install-method git
```

This installs gensparx **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/gensparx/gensparx/issues](https://github.com/gensparx/gensparx/issues)
[https://github.com/gensparx/gensparx/pulls](https://github.com/gensparx/gensparx/pulls)
...
- `gensparx status`: quick snapshot of gateway/agent health + basic config.
- `gensparx models status`: checks provider auth + model availability.
- `gensparx doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `gensparx status --all`, `gensparx logs --follow`,
`gensparx gateway status`, `gensparx health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Gensparx
...
If you don't have a global install yet, run it via `pnpm gensparx onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `GENSPARX_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `gensparx config get gateway.auth.token` (or generate one: `gensparx doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `gensparx gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `gensparx gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install gensparx on the new machine.
2. Copy `$GENSPARX_STATE_DIR` (default: `~/.gensparx`) from the old machine.
3. Copy your workspace (default: `~/.gensparx/workspace`).
4. Run `gensparx doctor` and restart the Gateway service.
...
under `~/.gensparx/` (for example `~/.gensparx/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-gensparx-store-its-data),
...
[https://github.com/gensparx/gensparx/blob/main/CHANGELOG.md](https://github.com/gensparx/gensparx/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.gensparx.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.gensparx.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.gensparx.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsgensparxai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/gensparx/gensparx/tree/main/docs](https://github.com/gensparx/gensparx/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://gensparx.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://gensparx.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://gensparx.ai/install.ps1](https://gensparx.ai/install.ps1)
...
```bash
curl -fsSL https://gensparx.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://gensparx.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://gensparx.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://gensparx.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or gensparx not recognized
...
**2) gensparx is not recognized after install**
...
If you still reproduce this on latest Gensparx, track/report it in:

- [Issue #30640](https://github.com/gensparx/gensparx/issues/30640)
...
### How do I install gensparx on Linux
...
### How do I install gensparx on a VPS
...
### Can I ask gensparx to update itself
...
```bash
gensparx update
gensparx update status
gensparx update --channel stable|beta|dev
gensparx update --tag <dist-tag|version>
gensparx update --no-restart
```

If you must automate from an agent:

```bash
gensparx update --yes --no-restart
gensparx gateway restart
```
...
`gensparx onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run gensparx with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like Gensparx.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `gensparx models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `gensparx models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `gensparx models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. gensparx no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so gensparx can keep replying while a provider is rate-limited.
...
gensparx supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. gensparx fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like Gensparx. The onboarding wizard can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Wizard](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `gensparx.json`.

Steps:

1. Enable the plugin: `gensparx plugins enable google-gemini-cli-auth`
2. Login: `gensparx models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. gensparx needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. gensparx runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run gensparx can I connect it to my MacBook Pro
...
- Use `gensparx nodes status` / `gensparx nodes list` to see it.
...
- DM your bot, then run `gensparx logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different gensparx instances
...
If you run gensparx via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the gensparx code install. Your state
(`~/.gensparx`) and workspace (`~/.gensparx/workspace`) stay untouched.
...
**Gensparx-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run gensparx on a dedicated machine
...
gensparx is lightweight. For a basic Gateway + one chat channel:
...
### Can I run gensparx in a VM and what are the requirements
...
### What is gensparx in one paragraph

gensparx is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

gensparx is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Gensparx
...
### Can gensparx help with lead gen outreach ads and blogs for a SaaS
...
gensparx draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

gensparx is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use gensparx when you
...
Showcase: [https://gensparx.ai/showcase](https://gensparx.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.gensparx/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.gensparx/gensparx.json`). Precedence is `<workspace>/skills` > `~/.gensparx/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.gensparx/gensparx.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.gensparx/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which gensparx treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `GENSPARX_SKIP_CRON` is not set.
...
```bash
gensparx cron run <jobId> --force
gensparx cron runs --id <jobId> --limit 50
```
...
### Can gensparx run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.gensparx.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-gensparx-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. gensparx can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.gensparx/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "gensparx": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured gensparx workspace); gensparx treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.gensparx/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
- Persist `/home/node` with `GENSPARX_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `GENSPARX_DOCKER_APT_PACKAGES`.
...
gensparx memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

gensparx also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, gensparx auto-selects a provider when it
...
configured and present, Gensparx
...
### Is all data used with gensparx saved locally

No - **Gensparx's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.gensparx` + your workspace directory).
...
### Where does gensparx store its data

Everything lives under `$GENSPARX_STATE_DIR` (default: `~/.gensparx`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$GENSPARX_STATE_DIR/gensparx.json`                             | Main config (JSON5)                                                |
| `$GENSPARX_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use)       |
| `$GENSPARX_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth, API keys, and optional `keyRef`/`tokenRef`)  |
| `$GENSPARX_STATE_DIR/secrets.json`                              | Optional file-backed secret payload for `file` SecretRef providers |
| `$GENSPARX_STATE_DIR/agents/<agentId>/agent/auth.json`          | Legacy compatibility file (static `api_key` entries scrubbed)      |
| `$GENSPARX_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)            |
| `$GENSPARX_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                              |
| `$GENSPARX_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                           |
| `$GENSPARX_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                       |

Legacy single-agent path: `~/.gensparx/agent/*` (migrated by `gensparx doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.gensparx/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.gensparx`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.gensparx`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.gensparx/skills`).

Default workspace is `~/.gensparx/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.gensparx/workspace" } },
}
```
...
Do **not** commit anything under `~/.gensparx` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Gensparx
...
`workspace` to the repo root. The gensparx repo is just source code; keep the
...
gensparx reads an optional **JSON5** config from `$GENSPARX_CONFIG_PATH` (default: `~/.gensparx/gensparx.json`):

```
$GENSPARX_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.gensparx/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `GENSPARX_GATEWAY_TOKEN`).
...
If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `gensparx doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one Gensparx.` every time.
- `random`: rotating funny/seasonal taglines (default behavior).
- If you want no banner at all, set env `GENSPARX_HIDE_BANNER=1`.

### How do I enable web search and web fetch

`web_fetch` works without an API key. `web_search` requires a Brave Search API
key. **Recommended:** run `gensparx configure --section web` to store it in
...
- Daemons read env vars from `~/.gensparx/.env` (or the service environment).
...
### Can the gensparx browser run headless
...
- Gateway is running: `gensparx gateway status`
- Gateway health: `gensparx status`
- Channel health: `gensparx channels status`
...
### Can two gensparx instances talk to each other local VPS
...
`gensparx agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
gensparx agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.gensparx/gensparx.json`).
- If you have no backup, re-run `gensparx doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `gensparx config set` for small changes.
- Use `gensparx configure` for interactive edits.
...
### How does gensparx load environment variables

gensparx reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.gensparx/.env` (aka `$GENSPARX_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.gensparx/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`GENSPARX_LOAD_SHELL_ENV=1`, `GENSPARX_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`gensparx models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means gensparx won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.gensparx/.env`:
...
### Is there a way to make a team of gensparx instances one CEO and many agents
...
### How do I completely reset gensparx but keep it installed
...
```bash
gensparx reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `GENSPARX_PROFILE`), reset each state dir (defaults are `~/.gensparx-<profile>`).
- Dev reset: `gensparx gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), gensparx skips the heartbeat run to save API calls.
...
No. gensparx runs on **your own account**, so if you're in the group, gensparx can see it.
...
```bash
gensparx directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't gensparx reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.gensparx/agents/<agentId>/sessions/`.
...
- Use `gensparx doctor` to spot stray workspaces and profile mismatches.
...
Gensparx's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, gensparx currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `gensparx models set ...` (updates just model config)
- `gensparx configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.gensparx/gensparx.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `gensparx doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Gensparx, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `gensparx models status`.
...
Yes. gensparx ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.gensparx/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `gensparx agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so gensparx can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.gensparx/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.gensparx/agent/*` (migrated by `gensparx doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.gensparx/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `gensparx models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `gensparx models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `gensparx models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.gensparx/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    gensparx models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), gensparx will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: gensparx now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
gensparx uses provider-prefixed IDs like:
...
gensparx may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `gensparx models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
gensparx models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
gensparx models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
gensparx models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
gensparx models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

gensparx supports both:
...
```
--port > GENSPARX_GATEWAY_PORT > gateway.port > default 18789
```

### Why does gensparx gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `gensparx gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does gensparx gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `GENSPARX_STATE_DIR` mismatch).

Fix:

```bash
gensparx gateway install --force
```
...
gensparx enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `gensparx gateway --port <port>`.

### How do I run gensparx in remote mode client connects to a Gateway elsewhere
...
- `gensparx gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `gensparx.control.settings.v1`.

Fix:

- Fastest: `gensparx dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `gensparx doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `GENSPARX_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `gensparx status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `GENSPARX_CONFIG_PATH` (per-instance config)
- `GENSPARX_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `gensparx --profile <name> …` per instance (auto-creates `~/.gensparx-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `gensparx --profile <name> gateway install`.

Profiles also suffix service names (`ai.gensparx.<profile>`; legacy `com.gensparx.*`, `gensparx-gateway-<profile>.service`, `gensparx Gateway (<profile>)`).
...
```
gensparx tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/gensparx/gensparx-YYYY-MM-DD.log
```
...
- macOS: `$GENSPARX_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.gensparx/logs/...`; profiles use `~/.gensparx-<profile>/logs/...`)
- Linux: `journalctl --user -u gensparx-gateway[-<profile>].service -n 200 --no-pager`
...
If you run the gateway manually, `gensparx gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Gensparx
...
1. Is the Gateway running? `gensparx gateway status`
2. Is the Gateway healthy? `gensparx status`
3. Does the UI have the right token? `gensparx dashboard`
...
```bash
gensparx channels status
gensparx channels logs --channel telegram
```
...
### ELI5 gensparx gateway restart vs gensparx gateway

- `gensparx gateway restart`: restarts the **background service** (launchd/systemd).
- `gensparx gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `gensparx gateway` when
...
```bash
gensparx message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose gensparx to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `gensparx pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `gensparx pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `gensparx doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. gensparx only replies to chats it receives or to explicit sends you trigger.
...
```bash
gensparx pairing list whatsapp
```
...
gensparx blocks **cross-provider** messaging by default. If a tool call is bound
