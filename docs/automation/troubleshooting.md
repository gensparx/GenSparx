...
gensparx system heartbeat last
gensparx logs --follow
gensparx config get agents.defaults.heartbeat
gensparx channels status --probe
```
...
```bash
gensparx config get agents.defaults.heartbeat.activeHours
gensparx config get agents.defaults.heartbeat.activeHours.timezone
gensparx config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
gensparx cron list
gensparx logs --follow
```
