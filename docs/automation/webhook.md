...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your gensparx config directory (typically `~/.gensparx/hooks/transforms`).
