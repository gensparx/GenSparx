...
summary: Machine-checked security models for Gensparx’s highest-risk paths.
read_when:
...
This page tracks Gensparx’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that gensparx enforces its
...
**What this is not (yet):** a proof that “gensparx is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/gensparx-formal-models](https://github.com/vignesh07/gensparx-formal-models).
...
```bash
git clone https://github.com/vignesh07/gensparx-formal-models
cd gensparx-formal-models
