  ...
  <Accordion title="From source" icon="github">
    ...
    <Steps>
      <Step title="Clone and build">
        Clone the [gensparx repo](https://github.com/gensparx/gensparx) and build:
...
If `$(npm prefix -g)/bin` (macOS/Linux) or `$(npm prefix -g)` (Windows) is **not** in your `$PATH`, your shell can't find global npm binaries (including `gensparx`).
