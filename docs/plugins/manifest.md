...
read_when:
  - You are building a gensparx plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (gensparx.plugin.json)

Every plugin **must** ship a `gensparx.plugin.json` file in the **plugin root**.
gensparx uses this manifest to validate configuration **without executing plugin
