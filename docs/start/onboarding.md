---
summary: "First-run onboarding flow for GenSparx (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give GenSparx">
...
<Step title="CLI">
  ...
  The app can install the global `gensparx` CLI via npm/pnpm so terminal
