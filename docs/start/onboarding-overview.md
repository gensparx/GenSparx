---
summary: "Overview of GenSparx onboarding options and flows"
read_when:
...
GenSparx supports multiple onboarding paths depending on where the Gateway runs
...
- [`gensparx onboard` command](/cli/onboard)

## macOS app onboarding

Use the GenSparx app when you want a fully guided setup on macOS. Docs:
