...
GenSparx has two separate “streaming” layers:
...
When block streaming is enabled, GenSparx can **merge consecutive block chunks**
...
When draft streaming is active, GenSparx disables block streaming for that reply to avoid double-streaming.
