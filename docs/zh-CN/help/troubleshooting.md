...
### `docs.gensparx.com` 显示 SSL 错误（Comcast/Xfinity）

一些 Comcast/Xfinity 连接通过 Xfinity Advanced Security 阻止 `docs.gensparx.com`。
禁用 Advanced Security 或将 `docs.gensparx.com` 添加到允许列表，然后重试。
