...
- [macOS 开发环境配置](/platforms/macos)
- [macOS 菜单栏](/platforms/macos)
- [macOS 语音唤醒](/platforms/macos)
- [macOS 语音悬浮窗](/platforms/macos)
- [macOS WebChat](/platforms/macos)
- [macOS Canvas](/platforms/macos)
- [macOS 子进程](/platforms/macos)
- [macOS 健康检查](/platforms/macos)
- [macOS 图标](/platforms/macos)
- [macOS 日志](/platforms/macos)
- [macOS 权限](/platforms/macos)
- [macOS 远程](/platforms/macos)
- [macOS 签名](/platforms/macos)
- [macOS 发布](/platforms/macos)
- [macOS Gateway 网关 (launchd)](/platforms/macos)
...
- [模板：AGENTS](/reference/AGENTS.default)
- [模板：BOOTSTRAP](/start/docs-directory)
- [模板：HEARTBEAT](/start/docs-directory)
- [模板：IDENTITY](/start/docs-directory)
- [模板：SOUL](/start/docs-directory)
- [模板：TOOLS](/start/docs-directory)
- [模板：USER](/start/docs-directory)

## 实验（探索性）

- [新手引导配置协议](/start/docs-directory)
- [定时任务加固笔记](/start/docs-directory)
- [群组策略加固笔记](/start/docs-directory)
- [研究：记忆](/start/docs-directory)
- [模型配置探索](/start/docs-directory)
