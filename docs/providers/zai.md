---
summary: "Use Z.AI (GLM models) with Gensparx"
read_when:
  - You want Z.AI / GLM models in Gensparx
...
for authentication. Create your API key in the Z.AI console. gensparx uses the `zai` provider
with a Z.AI API key.
