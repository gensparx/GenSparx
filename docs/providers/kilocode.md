---
summary: "Use Kilo Gateway's unified API to access many models in Gensparx"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in Gensparx
---
...
```bash
gensparx onboard --kilocode-api-key <key>
```
