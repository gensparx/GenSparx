...
```bash
gensparx chat --model venice/llama-3.3-70b "Hello, are you working?"
```
...
gensparx chat --model venice/llama-3.3-70b

# Use Claude via Venice (anonymized)
gensparx chat --model venice/claude-opus-45

# Use uncensored model
gensparx chat --model venice/venice-uncensored

# Use vision model with image
gensparx chat --model venice/qwen3-vl-235b-a22b

# Use coding model
gensparx chat --model venice/qwen3-coder-480b-a35b-instruct
```
