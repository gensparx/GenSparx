---
summary: "Use Qianfan's unified API to access many models in Gensparx"
read_when:
...
3. gensparx installed on your system
...
4. Copy the API key for use with Gensparx

## CLI setup

```bash
gensparx onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [gensparx Configuration](/gateway/configuration)
