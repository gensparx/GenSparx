---
summary: "Use Qwen OAuth (free tier) in Gensparx"
read_when:
  - You want to use Qwen with Gensparx
...
If you already logged in with the Qwen Code CLI, gensparx will sync credentials
