---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Gensparx"
read_when:
  - You want Xiaomi MiMo models in Gensparx
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). gensparx uses
