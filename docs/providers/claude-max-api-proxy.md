...
You can point GenSparx at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or GenSparx
...
- [Anthropic provider](/providers/anthropic) - Native GenSparx integration with Claude setup-token or API keys
