---
summary: "Use MiniMax M2.1 in GenSparx"
read_when:
...
- Use `gensparx models list` and `gensparx models set minimax/MiniMax-M2.1` to switch.
...
- Running `gensparx configure` and selecting **MiniMax M2.1**, or
