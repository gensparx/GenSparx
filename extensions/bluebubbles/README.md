...
This directory contains the **BlueBubbles external channel plugin** for Gensparx.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `gensparx/plugin-sdk` helpers.
