import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "gensparx/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
...
function setBlueBubblesDmPolicy(cfg: GensparxConfig, dmPolicy: DmPolicy): GensparxConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your gensparx gateway URL + webhook path",
