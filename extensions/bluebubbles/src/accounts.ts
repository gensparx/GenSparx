...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "gensparx/plugin-sdk";
...
export function listBlueBubblesAccountIds(cfg: GenSparxConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: GenSparxConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: GenSparxConfig): ResolvedBlueBubblesAccount[] {
