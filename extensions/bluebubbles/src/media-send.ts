...
import { resolveChannelMediaMaxBytes, type GensparxConfig } from "gensparx/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: GensparxConfig; accountId?: string }): string[] {
