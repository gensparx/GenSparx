import type {
  ...
  GensparxConfig,
} from "gensparx/plugin-sdk/zalo";
import { extractToolSend, jsonResult, readStringParam } from "gensparx/plugin-sdk/zalo";
import { listEnabledZaloAccounts } from "./accounts.js";
import { sendMessageZalo } from "./send.js";

const providerId = "zalo";

function listEnabledAccounts(cfg: GensparxConfig) {
