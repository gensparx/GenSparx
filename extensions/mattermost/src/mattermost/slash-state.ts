...
import type { GensparxPluginApi } from "gensparx/plugin-sdk/mattermost";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("gensparx/plugin-sdk/mattermost").GensparxConfig;
    runtime: import("gensparx/plugin-sdk/mattermost").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: GensparxPluginApi) {
