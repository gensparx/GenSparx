...
export function listMattermostAccountIds(cfg: GenSparxConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: GenSparxConfig): string {
...
export function listEnabledMattermostAccounts(cfg: GenSparxConfig): ResolvedMattermostAccount[] {
