import type { GensparxConfig, PluginRuntime, ResolvedLineAccount } from "gensparx/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: GensparxConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: GensparxConfig; accountId: string }): Promise<{
