import type { LineChannelData, GensparxPluginApi, ReplyPayload } from "gensparx/plugin-sdk/line";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: GensparxPluginApi): void {
  api.registerCommand({
    name: "card",
