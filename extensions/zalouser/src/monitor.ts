import type { GenSparxConfig, MarkdownTableMode, RuntimeEnv } from "gensparx/plugin-sdk";
import type { ChildProcess } from "node:child_process";
import { createReplyPrefixOptions, mergeAllowlist, summarizeMapping } from "gensparx/plugin-sdk";
