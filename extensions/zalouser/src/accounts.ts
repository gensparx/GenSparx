...
export function listZalouserAccountIds(cfg: GenSparxConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: GenSparxConfig): string {
...
function mergeZalouserAccountConfig(cfg: GenSparxConfig, accountId: string): ZalouserAccountConfig {
