/**
 * Synology Chat Channel Plugin for Gensparx.
 *
...
} from "gensparx/plugin-sdk/synology-chat";
import { z } from "zod";
...
export function createSynologyChatPlugin() {
  return {
    ...
    meta: {
      ...
      blurb: "Connect your Synology NAS Chat to Gensparx",
      order: 90,
    },
    ...
    pairing: {
      ...
      notifyApproval: async ({ cfg, id }: { cfg: any; id: string }) => {
        ...
        await sendMessage(
          account.incomingUrl,
          "Gensparx: your access has been approved.",
          id,
    ...
    security: {
      resolveDmPolicy: ({
        ...
        return {
          ...
          approveHint: "gensparx pairing approve synology-chat <code>",
