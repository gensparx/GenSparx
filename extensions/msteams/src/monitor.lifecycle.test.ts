...
import type { GensparxConfig, RuntimeEnv } from "gensparx/plugin-sdk/msteams";
...
vi.mock("gensparx/plugin-sdk/msteams", () => ({
...
function createConfig(port: number): GensparxConfig {
  return {
    channels: {
      msteams: {
        enabled: true,
