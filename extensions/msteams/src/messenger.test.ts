...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "gensparx/plugin-sdk/msteams";
...
import { resolvePreferredGensparxTmpDir } from "../../../src/infra/tmp-gensparx-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredGensparxTmpDir(), "msteams-mention-"));
