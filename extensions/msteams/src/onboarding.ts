import type {
  ...
  WizardPrompter,
  MSTeamsTeamConfig,
} from "gensparx/plugin-sdk/msteams";
import {
...
function setMSTeamsDmPolicy(cfg: GensparxConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: GensparxConfig, allowFrom: string[]): GensparxConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
