...
import { fetchWithSsrFGuard } from "gensparx/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to gensparx workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".gensparx", "workspace", "media", "inbound");
 ...
 * Format matches Gensparx's expected attachment structure.
 */
