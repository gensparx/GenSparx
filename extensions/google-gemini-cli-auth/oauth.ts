...
import { fetchWithSsrFGuard, isWSL2Sync } from "gensparx/plugin-sdk/google-gemini-cli-auth";

const CLIENT_ID_KEYS = ["GENSPARX_GEMINI_OAUTH_CLIENT_ID", "GEMINI_CLI_OAUTH_CLIENT_ID"];
      ...
      try {
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head>" +
            ...
            "<p>You can close this window and return to Gensparx.</p></body></html>",
        );
