import type { GensparxConfig, GensparxPluginApi } from "gensparx/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: GensparxConfig): { id: string; name: string } {
