...
import type { GensparxPluginApi, GensparxPluginToolContext } from "gensparx/plugin-sdk/lobster";
...
describe("lobster plugin tool", () => {
  ...
  beforeAll(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "gensparx-lobster-plugin-"));
  });
