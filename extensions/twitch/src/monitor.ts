...
import type { ReplyPayload, GensparxConfig } from "gensparx/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "gensparx/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as GensparxConfig;
