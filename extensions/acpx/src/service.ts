import type {
  ...
  PluginLogger,
} from "gensparx/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "gensparx/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: GensparxPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: GensparxPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
