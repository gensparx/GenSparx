...
Nostr DM channel plugin for GenSparx using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to GenSparx. It enables your bot to:
...
```bash
gensparx plugins install @openclaw/nostr
```
...
# Configure GenSparx to use local relay
