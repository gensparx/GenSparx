...
import type { GensparxConfig } from "gensparx/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: GensparxConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: GensparxConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: GensparxConfig): string {
