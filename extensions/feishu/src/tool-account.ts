...
import type { GensparxPluginApi } from "gensparx/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: GensparxPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<GensparxPluginApi, "config">;
