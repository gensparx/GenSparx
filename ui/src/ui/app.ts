...
@customElement("gensparx-app")
export class GenSparxApp extends LitElement {
...
// Backward compatibility for pre-rebrand imports and tests.
export { GenSparxApp as OpenClawApp };
if (!customElements.get("openclaw-app")) {
  customElements.define("openclaw-app", GenSparxApp);
}
