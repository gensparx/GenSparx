...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.gensparx/gensparx.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde gensparx dashboard --no-open en tu escritorio.",
    },
    insecure: {
