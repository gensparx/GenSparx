...
validate_mount_path_value "OPENCLAW_CONFIG_DIR" "$CONFIG_DIR"
validate_mount_path_value "OPENCLAW_WORKSPACE_DIR" "$WORKSPACE_DIR"
...
if [[ -z "${GENSPARX_GATEWAY_TOKEN:-}" ]]; then
  if [[ -n "${OPENCLAW_GATEWAY_TOKEN:-}" ]]; then
    GENSPARX_GATEWAY_TOKEN="$OPENCLAW_GATEWAY_TOKEN"
