...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.gensparx.gateway"
    private static let nodeService = "ai.gensparx.node"
    private static let talkService = "ai.gensparx.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.gensparx.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.gensparx.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("gensparx-gateway.log")
    }
