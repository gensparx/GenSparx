...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.gensparx.ios", category: "LiveActivity")
    private var currentActivity: Activity<GensparxActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = GensparxActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<GensparxActivityAttributes>.activities
    ...
    private func updateCurrent(state: GensparxActivityAttributes.ContentState) {
    ...
    private func connectingState() -> GensparxActivityAttributes.ContentState {
        GensparxActivityAttributes.ContentState(
    ...
    private func idleState() -> GensparxActivityAttributes.ContentState {
        GensparxActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> GensparxActivityAttributes.ContentState {
        GensparxActivityAttributes.ContentState(
