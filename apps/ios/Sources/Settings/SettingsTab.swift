...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = GensparxLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = GensparxLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.gensparx.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected gensparx agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while gensparx is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Gensparx. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(GensparxLocationMode.off.rawValue)
                            Text("While Using").tag(GensparxLocationMode.whileUsing.rawValue)
                            Text("Always").tag(GensparxLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while gensparx is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Gensparx", value: DeviceInfoHelper.gensparxVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = GensparxLocationMode(rawValue: newValue) else { return }
                Task {
