...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: GensparxPhotosLatestParams) async throws -> GensparxPhotosLatestPayload {
        ...
        var results: [GensparxPhotoPayload] = []
        ...
        return GensparxPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> GensparxPhotoPayload
    {
