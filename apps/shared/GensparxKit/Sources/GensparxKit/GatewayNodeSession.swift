...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.gensparx", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.gensparx", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: GensparxProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
