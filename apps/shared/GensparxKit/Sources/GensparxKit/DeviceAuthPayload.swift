...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: GensparxProtocol.AnyCodable]?
    {
        ...
        return [
            "id": GensparxProtocol.AnyCodable(identity.deviceId),
            "publicKey": GensparxProtocol.AnyCodable(publicKey),
            "signature": GensparxProtocol.AnyCodable(signature),
            "signedAt": GensparxProtocol.AnyCodable(signedAtMs),
            "nonce": GensparxProtocol.AnyCodable(nonce),
        ]
    }
}
