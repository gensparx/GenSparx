...
public enum GensparxTalkCommand: String, Codable, Sendable {
...
public struct GensparxTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct GensparxTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
