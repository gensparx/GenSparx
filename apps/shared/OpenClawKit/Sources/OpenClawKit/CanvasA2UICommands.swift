...
public enum GensparxCanvasA2UICommand: String, Codable, Sendable {
...
public struct GensparxCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct GensparxCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
