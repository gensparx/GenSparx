...
@MainActor
public struct GensparxChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: GensparxChatViewModel
    ...
    public init(
        viewModel: GensparxChatViewModel,
    ...
    private var visibleMessages: [GensparxChatMessage] {
        let base: [GensparxChatMessage]
    ...
    private func mergeToolResults(in messages: [GensparxChatMessage]) -> [GensparxChatMessage] {
        ...
        for message in messages {
            ...
            let merged = GensparxChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: GensparxChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: GensparxChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: GensparxChatMessage) -> String {
