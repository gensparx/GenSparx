...
public typealias GensparxPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias GensparxPlatformImage = UIImage
#endif

public struct GensparxChatUsageCost: Codable, Hashable, Sendable {
...
public struct GensparxChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: GensparxChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(GensparxChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct GensparxChatMessageContent: Codable, Hashable, Sendable {
...
public struct GensparxChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [GensparxChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: GensparxChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [GensparxChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: GensparxChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(GensparxChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([GensparxChatMessageContent].self, forKey: .content) {
...
public struct GensparxChatHistoryPayload: Codable, Sendable {
...
public struct GensparxSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct GensparxSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [GensparxSessionPreviewItem]
}

public struct GensparxSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [GensparxSessionPreviewEntry]

    public init(ts: Int, previews: [GensparxSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct GensparxChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct GensparxChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct GensparxAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct GensparxChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct GensparxGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct GensparxPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: GensparxPlatformImage?
...
public struct GensparxChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
