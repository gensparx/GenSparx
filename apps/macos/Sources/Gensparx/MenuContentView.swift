...
/// Menu contents for the gensparx menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About Gensparx") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "gensparx Not Configured"
        case .remote:
            "Remote gensparx Active"
        case .local:
            "gensparx Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .gensparxSelectSettingsTab, object: tab)
        }
    }
