...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .gensparxSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? GensparxPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? GensparxPaths.stateDirURL.path
...
extension Notification.Name {
    static let gensparxSelectSettingsTab = Notification.Name("gensparxSelectSettingsTab")
}
