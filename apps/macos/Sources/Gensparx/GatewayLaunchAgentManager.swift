...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.gensparx", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".gensparx/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.gensparxCommand(
            subcommand: "gateway",
