...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = GensparxConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = GensparxConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = GensparxConfigFile.loadDict()
            ...
            GensparxConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/gensparx"
        state.remoteCliPath = ""
        return state
    }
}
