...
enum UIStrings {
    static let welcomeTitle = "Welcome to Gensparx"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "gensparx.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: GensparxChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g gensparx@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: GensparxChatViewModel(
