...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/gensparx/gensparx") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/gensparx/gensparx")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://gensparx.com")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "GensparxBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "GensparxBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "GensparxGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "GensparxGitCommit") as? String) ??
            "unknown"
    }
