...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.gensparx", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other gensparx windows, but below the system’s pop-up menus.
