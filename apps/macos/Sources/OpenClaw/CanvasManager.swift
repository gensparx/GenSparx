...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.gensparx", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Gensparx/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__gensparx__/a2ui/").absoluteString + "?platform=macos"
    }
