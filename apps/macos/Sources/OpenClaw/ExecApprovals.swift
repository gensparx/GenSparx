...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.gensparx", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        GensparxPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        GensparxPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
