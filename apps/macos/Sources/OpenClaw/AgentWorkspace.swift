...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.gensparx", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return GensparxConfigFile.defaultWorkspaceURL() }
