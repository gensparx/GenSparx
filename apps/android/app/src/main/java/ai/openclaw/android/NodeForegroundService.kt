...
class NodeForegroundService : Service() {
    ...
    notificationJob =
      scope.launch {
        combine(
          ...
          val title = if (connected) "gensparx Node · Connected" else "gensparx Node"
          val micSuffix =
            if (micEnabled) {
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = "gensparx node connection status"
        setShowBadge(false)
      }
  ...
  companion object {
    ...
    private const val ACTION_STOP = "ai.gensparx.android.action.STOP"
