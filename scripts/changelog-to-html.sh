...
if [[ -z "$version_content" ]]; then
  echo "<h2>gensparx $VERSION</h2>"
  echo "<p>Latest gensparx update.</p>"
  echo "<p><a href=\"https://github.com/gensparx/gensparx/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
