...
- Keep product names in English: Gensparx, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the gensparx Gateway, use “Gateway 网关”.
