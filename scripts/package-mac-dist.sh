...
# Output:
# - dist/Gensparx.app
# - dist/Gensparx-<version>.zip
# - dist/Gensparx-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.gensparx.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Gensparx.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Gensparx-$VERSION.zip"
DMG="$ROOT_DIR/dist/Gensparx-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Gensparx-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Gensparx-$VERSION.dSYM.zip"
