    ...
    await withTempHome(
      async (tempHome) => {
        ...
        const env = {
          ...
          GENSPARX_TEST_FAST: "1",
        };
        delete env.GENSPARX_HOME;
        delete env.GENSPARX_STATE_DIR;
        delete env.GENSPARX_CONFIG_PATH;
        delete env.VITEST;

        const entry = path.resolve(process.cwd(), "gensparx.mjs");
